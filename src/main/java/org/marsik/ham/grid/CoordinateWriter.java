...
public class CoordinateWriter {
    private static final Pattern LAT_RE = Pattern.compile("([NS])?([0-9]{0,3}) +([0-9]{1,2}.[0-9]{0,})?", Pattern.CASE_INSENSITIVE);
    private static final Pattern LON_RE = Pattern.compile("([EW])?([0-9]{0,3}) +([0-9]{1,2}.[0-9]{0,})?", Pattern.CASE_INSENSITIVE);
